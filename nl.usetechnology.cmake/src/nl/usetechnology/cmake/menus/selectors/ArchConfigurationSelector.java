...
public class ArchConfigurationSelector implements MenuItemPostProcessor {

	@Override
	public void postProcess(MenuItemBuilder builder, MenuItem item, IProject project) {
		if(builder.getName().endsWith(ProjectSettingsAccessor.retrieveArchitecture(project))) {
